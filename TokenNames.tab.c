...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_IF_TOKEN = 3,                   /* IF_TOKEN  */
  YYSYMBOL_ELSE_TOKEN = 4,                 /* ELSE_TOKEN  */
...
static const char *const yytname[] =
{
  ...
  "DECREMENT_TOKEN", "ASSN_TOKEN", "ADD_ASSN_TOKEN", "MINUS_ASSN_TOKEN",
  "MULTI_ASSN_TOKEN", "DIVIDE_ASSN_TOKEN", "MODULO_ASSN_TOKEN",
  "AND_ASSN_TOKEN", "OR_ASSN_TOKEN", "XOR_ASSN_TOKEN", "EQUAL_COMP_TOKEN",
  "NOT_EQUAL_COMP_TOKEN", "LESS_THAN_COMP_TOKEN",
  "GREATER_THAN_COMP_TOKEN", "LESS_THAN_EQUAL_COMP_TOKEN",
  "GREATER_THAN_EQUAL_COMP_TOKEN", "LOGICAL_AND_TOKEN", "LOGICAL_OR_TOKEN",
  "LOGICAL_NOT_TOKEN", "BITWISE_AND_TOKEN", "BITWISE_OR_TOKEN",
  "BITWISE_XOR_TOKEN", "BITWISE_LSHIFT_TOKEN", "BITWISE_RSHIFT_TOKEN",
  "BITWISE_NOT_TOKEN", "NUM_TOKEN", "$accept", "filler", YY_NULLPTR
};
